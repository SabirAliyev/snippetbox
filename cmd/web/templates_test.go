...
func TestHumanDate(t *testing.T) {
	...
	// If it isn`t we expect, use the t.Error() function to indicate that the test
	// has failed and log the expected and actual values.
	if hd != "17 Dec 2020 at 10:00" {
		t.Errorf("want %q; got %q", "17 Dec2020 at 10:00", hd)
	}
}